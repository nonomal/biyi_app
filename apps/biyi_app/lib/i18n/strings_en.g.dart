...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'app_name': return 'Biyi';
			case 'ok': return 'OK';
			case 'cancel': return 'Cancel';
			case 'add': return 'Add';
			case 'delete': return 'Delete';
			case 'copied': return 'Copied';
			case 'please_choose': return 'Please Choose';
			case 'language.af': return 'Afrikaans';
			case 'language.am': return 'Amharic';
			case 'language.ar': return 'Arabic';
			case 'language.az': return 'Azerbaijani';
			case 'language.be': return 'Belarusian';
			case 'language.bg': return 'Bulgarian';
			case 'language.bn': return 'Bengali';
			case 'language.bs': return 'Bosnian';
			case 'language.ca': return 'Catalan';
			case 'language.ceb': return 'Cebuano';
			case 'language.co': return 'Corsican';
			case 'language.cs': return 'Czech';
			case 'language.cy': return 'Welsh';
			...
			case 'language.eu': return 'Basque';
			case 'language.fa': return 'Persian';
			case 'language.fi': return 'Finnish';
			case 'language.fr': return 'French';
			case 'language.fy': return 'Frisian';
			case 'language.ga': return 'Irish';
			case 'language.gd': return 'Scots Gaelic';
			case 'language.gl': return 'Galician';
			case 'language.gu': return 'Gujarati';
			case 'language.ha': return 'Hausa';
			case 'language.haw': return 'Hawaiian';
			case 'language.he': return 'Hebrew';
			case 'language.hi': return 'Hindi';
			case 'language.hmn': return 'Hmong';
			case 'language.hr': return 'Croatian';
			case 'language.ht': return 'Haitian Creole';
			case 'language.hu': return 'Hungarian';
			case 'language.hy': return 'Armenian';
			case 'language.id': return 'Indonesian';
			case 'language.ig': return 'Igbo';
			case 'language.kIs': return 'Icelandic';
			case 'language.it': return 'Italian';
			case 'language.iw': return 'Hebrew';
			case 'language.ja': return 'Japanese';
			case 'language.jw': return 'Javanese';
			case 'language.ka': return 'Georgian';
			case 'language.kk': return 'Kazakh';
			case 'language.km': return 'Khmer';
			case 'language.kn': return 'Kannada';
			case 'language.ko': return 'Korean';
			case 'language.ku': return 'Kurdish (Kurmanji)';
			case 'language.ky': return 'Kyrgyz';
			case 'language.la': return 'Latin';
			case 'language.lb': return 'Luxembourgish';
			case 'language.lo': return 'Lao';
			case 'language.lt': return 'Lithuanian';
			case 'language.lv': return 'Latvian';
			case 'language.mg': return 'Malagasy';
			case 'language.mi': return 'Maori';
			case 'language.mk': return 'Macedonian';
			case 'language.ml': return 'Malayalam';
			case 'language.mn': return 'Mongolian';
			case 'language.mr': return 'Marathi';
			case 'language.ms': return 'Malay';
			case 'language.mt': return 'Maltese';
			case 'language.my': return 'Myanmar (Burmese)';
			case 'language.ne': return 'Nepali';
			case 'language.nl': return 'Dutch';
			case 'language.no': return 'Norwegian';
			case 'language.ny': return 'Chichewa';
			case 'language.or': return 'Odia (Oriya)';
			case 'language.pa': return 'Punjabi';
			case 'language.pl': return 'Polish';
			case 'language.ps': return 'Pashto';
			case 'language.pt': return 'Portuguese';
			case 'language.ro': return 'Romanian';
			case 'language.ru': return 'Russian';
			case 'language.rw': return 'Kinyarwanda';
			case 'language.sd': return 'Sindhi';
			case 'language.si': return 'Sinhala';
			case 'language.sk': return 'Slovak';
			case 'language.sl': return 'Slovenian';
			case 'language.sm': return 'Samoan';
			case 'language.sn': return 'Shona';
			case 'language.so': return 'Somali';
			case 'language.sq': return 'Albanian';
			case 'language.sr': return 'Serbian';
			case 'language.st': return 'Sesotho';
			case 'language.su': return 'Sundanese';
			case 'language.sv': return 'Swedish';
			case 'language.sw': return 'Swahili';
			case 'language.ta': return 'Tamil';
			case 'language.te': return 'Telugu';
			case 'language.tg': return 'Tajik';
			case 'language.th': return 'Thai';
			case 'language.tk': return 'Turkmen';
			case 'language.tl': return 'Filipino';
			case 'language.tr': return 'Turkish';
			case 'language.tt': return 'Tatar';
			case 'language.ug': return 'Uyghur';
			case 'language.uk': return 'Ukrainian';
			case 'language.ur': return 'Urdu';
			case 'language.uz': return 'Uzbek';
			case 'language.vi': return 'Vietnamese';
			case 'language.xh': return 'Xhosa';
			case 'language.yi': return 'Yiddish';
			case 'language.yo': return 'Yoruba';
			case 'language.zh': return 'Chinese';
			case 'language.zh_CN': return 'Chinese';
			case 'language.zh_TW': return 'Chinese (Traditional)';
			case 'language.zu': return 'Zulu';
			case 'engine.baidu': return 'Baidu';
			case 'engine.caiyun': return 'Caiyun';
			case 'engine.deepl': return 'DeepL';
			case 'engine.google': return 'Google';
			case 'engine.ibmwatson': return 'IBMWatson';
			case 'engine.iciba': return 'Iciba';
			case 'engine.openai': return 'OpenAI';
			case 'engine.sogou': return 'Sogou';
			case 'engine.tencent': return 'Tencent';
			case 'engine.youdao': return 'Youda';
			case 'engine_scope.detectlanguage': return 'detectLanguage';
			case 'engine_scope.lookup': return 'LookUp';
			case 'engine_scope.translate': return 'Translate';
			case 'ocr_engine.built_in': return 'Built In';
			case 'ocr_engine.tesseract': return 'Tesseract OCR';
			case 'ocr_engine.youdao': return 'Youdao';
			case 'translation_mode.auto': return 'Auto';
			case 'translation_mode.manual': return 'Manual';
			case 'theme_mode.light': return 'Light';
			case 'theme_mode.dark': return 'Dark';
			case 'theme_mode.system': return 'System';
			case 'word_pronunciation.us': return 'US';
			case 'word_pronunciation.uk': return 'UK';
			case 'tray_context_menu.item_show': return 'Show';
			case 'tray_context_menu.item_quick_start_guide': return 'Quick Start';
			case 'tray_context_menu.item_discussion': return 'Join Discussion';
			case 'tray_context_menu.item_quit_app': return 'Quit Biyi';
			case 'tray_context_menu.item_discussion_subitem_discord_server': return 'Join Discord';
			case 'tray_context_menu.item_discussion_subitem_qq_group': return 'Join QQ Group';
			case 'app.home.newversion_banner_text_found_new_version': return ({required Object version}) => 'New version found: ${version}';
			case 'app.home.newversion_banner_btn_update': return 'Update';
			case 'app.home.limited_banner_title': return 'Functionality is limited, please perform a check according to the prompts.';
			case 'app.home.limited_banner_text_screen_capture': return 'Grant screen recording access';
			case 'app.home.limited_banner_text_screen_selection': return 'Grant accessibility access';
			case 'app.home.limited_banner_btn_allow': return 'Allow';
			case 'app.home.limited_banner_btn_go_settings': return 'Go Settings';
			case 'app.home.limited_banner_btn_check_again': return 'Check Again';
			case 'app.home.limited_banner_tip_help': return 'View the help document';
			case 'app.home.limited_banner_msg_allow_access_tip': return 'If there is no response after clicking "Allow", please click "Go Settings" to set it manually.';
			case 'app.home.limited_banner_msg_all_access_allowed': return 'The Screen extract text is enabled';
			case 'app.home.limited_banner_msg_all_access_not_allowed': return 'The required access are not allowed.\nPlease check and set again.';
			case 'app.home.input_hint': return 'Enter the word or text here';
			case 'app.home.text_extracting_text': return 'Extracting text...';
			case 'app.home.tip_translation_mode': return ({required Object mode}) => 'Current translation mode: ${mode}';
			case 'app.home.tip_extract_text_from_screen_capture': return 'Capture screen area and recognize text';
			case 'app.home.tip_extract_text_from_clipboard': return 'Read clipboard content';
			case 'app.home.btn_clear': return 'Clear';
			case 'app.home.btn_trans': return 'Translate';
			case 'app.home.msg_please_enter_word_or_text': return 'No text entered or text not extracted';
			case 'app.home.msg_capture_screen_area_canceled': return 'Capture screen area has been canceled';
			case 'app.record_shortcut.title': return 'Record your shortcut';
			case 'app.ocr_engine_types.title': return 'Engine Type';
			case 'app.ocr_engines.title': return 'Text Detections Engines';
			case 'app.ocr_engines.msg.no_available_engines': return 'No available engines';
			case 'app.ocr_engines.private.title': return 'Private';
			case 'app.ocr_engines_new.title': return 'Add Text Detection Engine';
			case 'app.ocr_engines_new.engine_type.title': return 'Engine type';
			case 'app.ocr_engines_new.option.title': return 'Option';
			case 'app.settings.title': return 'Settings';
			case 'app.settings.text_version': return ({required Object version, required Object buildNumber}) => 'Version ${version} BUILD ${buildNumber}';
			case 'app.settings.kLayout.navgroup.client': return 'Client';
			case 'app.settings.kLayout.navgroup.integrations': return 'Integrations';
			case 'app.settings.kLayout.navgroup.resources': return 'Resources';
			case 'app.settings.about.title': return 'About';
			case 'app.settings.about.package_info.version': return 'Version';
			case 'app.settings.about.package_info.build_number': return 'Build Number';
			case 'app.settings.advanced.title': return 'Advanced';
			case 'app.settings.advanced.launch_at_login.title': return 'Launch at login';
			case 'app.settings.appearance.title': return 'Appearance';
			case 'app.settings.appearance.subtitle': return 'Change the look of your client.';
			case 'app.settings.appearance.tray_icon.title': return 'Tray Icon';
			case 'app.settings.appearance.tray_icon.style.title': return 'Tray Icon Style';
			case 'app.settings.appearance.tray_icon.show.title': return 'Show Tray Icon';
			case 'app.settings.appearance.max_window_height.title': return 'Maximum window height (logical pixels)';
			case 'app.settings.changelog.title': return 'Changelog';
			case 'app.settings.changelog.subtitle': return 'See what cool new features we\'re making.';
			case 'app.settings.general.title': return 'General';
			case 'app.settings.general.subtitle': return 'General settings related to the client.';
			case 'app.settings.general.default_detect_text_engine.title': return 'Default detect text engine';
			case 'app.settings.general.extract_text.auto_copy_detected_text.title': return 'Auto copy the detected text';
			case 'app.settings.general.default_translate_engine.title': return 'Default translate engine';
			case 'app.settings.general.translation_mode.title': return 'Translation Mode';
			case 'app.settings.general.default_detect_language_engine.title': return 'Default detect language engine';
			case 'app.settings.general.translation_target.title': return 'Translation target';
			case 'app.settings.general.translate.double_click_copy_result.title': return 'Double-click to copy translation result';
			case 'app.settings.general.input_settings.title': return 'Input Settings';
			case 'app.settings.general.input_settings.submit_with_enter.title': return 'Submit with Enter';
			case 'app.settings.general.input_settings.submit_with_meta_enter.title': return 'Submit with Ctrl + Enter';
			case 'app.settings.general.input_settings.submit_with_meta_enter_mac.title': return 'Submit with ⌘ + Enter';
			case 'app.settings.keybinds.title': return 'Keybinds';
			case 'app.settings.keybinds.subtitle': return 'View and manage client keybinds';
			case 'app.settings.keybinds.window.show_or_hide.title': return 'Show/Hide';
			case 'app.settings.keybinds.window.hide.title': return 'Hide';
			case 'app.settings.keybinds.extract_text.title': return 'Screen / Clipboard extract text';
			case 'app.settings.keybinds.extract_text.from_selection.title': return 'Selection';
			case 'app.settings.keybinds.extract_text.from_capture.title': return 'Capture Area';
			case 'app.settings.keybinds.extract_text.from_clipboard.title': return 'Clipboard';
			case 'app.settings.keybinds.input_assist_function.title': return 'Input assist function';
			case 'app.settings.keybinds.input_assist_function.translate_input_content.title': return 'Translate input content';
			case 'app.settings.language.title': return 'Language';
			case 'app.settings.ocr_engines.title': return 'Text Detections';
			case 'app.settings.ocr_engines.private.title': return 'Private';
			case 'app.settings.ocr_engines.private.description': return 'Long press an item to reorder it';
			case 'app.settings.translation_engines.title': return 'Text Translations';
			case 'app.settings.translation_engines.private.title': return 'Private';
			case 'app.settings.translation_engines.private.description': return 'Long press an item to reorder it';
			case 'app.supported_languages.title': return 'Supported Languages';
			case 'app.supported_languages.all.title': return 'All';
			case 'app.translation_engine_types.title': return 'Engine Type';
			case 'app.translation_engines.title': return 'Text Translation Engines';
			case 'app.translation_engines.msg.no_available_engines': return 'No available engines';
			case 'app.translation_engines.private.title': return 'Private';
			case 'app.translation_engines_new.title': return 'Add Text Translation Engine';
			case 'app.translation_engines_new.engine_type.title': return 'Engine type';
			case 'app.translation_engines_new.support_interface.title': return 'Support interface';
			case 'app.translation_engines_new.option.title': return 'Option';
			case 'app.translation_targets.kNew.title': return 'Add Translation Target';
			case 'app.translation_targets.kNew.title_with_edit': return 'Edit Translation Target';
			case 'app.translation_targets.kNew.source_language': return 'Source language';
			case 'app.translation_targets.kNew.target_language': return 'Target language';
			case 'widget.record_shortcut_dialog.title': return 'Customize your shortcut';
			default: return null;
		}
	}
}
