...
extension on TranslationsZhCn {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'app_name': return '比译';
			case 'ok': return '确定';
			case 'cancel': return '取消';
			case 'add': return '添加';
			case 'delete': return '删除';
			case 'copied': return '已复制';
			case 'please_choose': return '请选择';
			case 'language.af': return '布尔语(南非荷兰语)';
			case 'language.am': return '阿姆哈拉语';
			case 'language.ar': return '阿拉伯语';
			case 'language.az': return '阿塞拜疆语';
			case 'language.be': return '白俄罗斯语';
			case 'language.bg': return '保加利亚语';
			case 'language.bn': return '孟加拉语';
			case 'language.bs': return '波斯尼亚语';
			case 'language.ca': return '加泰罗尼亚语';
			case 'language.ceb': return '宿务语';
			case 'language.co': return '科西嘉语';
			case 'language.cs': return '捷克语';
			case 'language.cy': return '威尔士语';
			case 'language.da': return '丹麦语';
			case 'language.de': return '德语';
			case 'language.el': return '希腊语';
			case 'language.en': return '英语';
			case 'language.eo': return '世界语';
			case 'language.es': return '西班牙语';
			case 'language.et': return '爱沙尼亚语';
			case 'language.eu': return '巴斯克语';
			case 'language.fa': return '波斯语';
			case 'language.fi': return '芬兰语';
			case 'language.fr': return '法语';
			case 'language.fy': return '弗里西语';
			case 'language.ga': return '爱尔兰语';
			case 'language.gd': return '苏格兰盖尔语';
			case 'language.gl': return '加利西亚语';
			case 'language.gu': return '古吉拉特语';
			case 'language.ha': return '豪萨语';
			case 'language.haw': return '夏威夷语';
			case 'language.he': return '希伯来语';
			case 'language.hi': return '印地语';
			case 'language.hmn': return '苗语';
			case 'language.hr': return '克罗地亚语';
			case 'language.ht': return '海地克里奥尔语';
			case 'language.hu': return '匈牙利语';
			case 'language.hy': return '亚美尼亚语';
			case 'language.id': return '印尼语';
			case 'language.ig': return '伊博语';
			case 'language.kIs': return '冰岛语';
			case 'language.it': return '意大利语';
			case 'language.iw': return '希伯来语';
			case 'language.ja': return '日语';
			case 'language.jw': return '印尼爪哇语';
			case 'language.ka': return '格鲁吉亚语';
			case 'language.kk': return '哈萨克语';
			case 'language.km': return '高棉语';
			case 'language.kn': return '卡纳达语';
			case 'language.ko': return '韩语';
			case 'language.ku': return '库尔德语';
			case 'language.ky': return '吉尔吉斯语';
			case 'language.la': return '拉丁语';
			case 'language.lb': return '卢森堡语';
			case 'language.lo': return '老挝语';
			case 'language.lt': return '立陶宛语';
			case 'language.lv': return '拉脱维亚语';
			case 'language.mg': return '马尔加什语';
			case 'language.mi': return '毛利语';
			case 'language.mk': return '马其顿语';
			case 'language.ml': return '马拉雅拉姆语';
			case 'language.mn': return '蒙古语';
			case 'language.mr': return '马拉地语';
			case 'language.ms': return '马来语';
			case 'language.mt': return '马耳他语';
			case 'language.my': return '缅甸语';
			case 'language.ne': return '尼泊尔语';
			case 'language.nl': return '荷兰语';
			case 'language.no': return '挪威语';
			case 'language.ny': return '齐切瓦语';
			case 'language.or': return '奥利亚语';
			case 'language.pa': return '旁遮普语';
			case 'language.pl': return '波兰语';
			case 'language.ps': return '普什图语';
			case 'language.pt': return '葡萄牙语';
			case 'language.ro': return '罗马尼亚语';
			case 'language.ru': return '俄语';
			case 'language.rw': return '卢旺达语';
			case 'language.sd': return '信德语';
			case 'language.si': return '僧伽罗语';
			case 'language.sk': return '斯洛伐克语';
			case 'language.sl': return '斯洛文尼亚语';
			case 'language.sm': return '萨摩亚语';
			case 'language.sn': return '修纳语';
			case 'language.so': return '索马里语';
			case 'language.sq': return '阿尔巴尼亚语';
			case 'language.sr': return '塞尔维亚语';
			case 'language.st': return '塞索托语';
			case 'language.su': return '印尼巽他语';
			case 'language.sv': return '瑞典语';
			case 'language.sw': return '斯瓦希里语';
			case 'language.ta': return '泰米尔语';
			case 'language.te': return '泰卢固语';
			case 'language.tg': return '塔吉克语';
			case 'language.th': return '泰语';
			case 'language.tk': return '土库曼语';
			case 'language.tl': return '菲律宾语';
			case 'language.tr': return '土耳其语';
			case 'language.tt': return '鞑靼语';
			case 'language.ug': return '维吾尔语';
			case 'language.uk': return '乌克兰语';
			case 'language.ur': return '乌尔都语';
			case 'language.uz': return '乌兹别克语';
			case 'language.vi': return '越南语';
			case 'language.xh': return '南非科萨语';
			case 'language.yi': return '意第绪语';
			case 'language.yo': return '约鲁巴语';
			case 'language.zh': return '中文';
			case 'language.zh_CN': return '中文';
			case 'language.zh_TW': return '中文(繁体)';
			case 'language.zu': return '南非祖鲁语';
			case 'engine.baidu': return '百度翻译';
			case 'engine.caiyun': return '彩云小译';
			case 'engine.deepl': return 'DeepL';
			case 'engine.google': return '谷歌翻译';
			case 'engine.ibmwatson': return 'IBMWatson';
			case 'engine.iciba': return '爱词霸';
			case 'engine.openai': return 'OpenAI';
			case 'engine.sogou': return '搜狗翻译';
			case 'engine.tencent': return '腾讯翻译君';
			case 'engine.youdao': return '有道翻译';
			case 'engine_scope.detectlanguage': return '语种识别';
			case 'engine_scope.lookup': return '查词';
			case 'engine_scope.translate': return '翻译';
			case 'ocr_engine.built_in': return '内置';
			case 'ocr_engine.tesseract': return 'Tesseract OCR';
			case 'ocr_engine.youdao': return '有道通用文字识别';
			case 'translation_mode.auto': return '自动';
			case 'translation_mode.manual': return '手动';
			case 'theme_mode.light': return '浅色';
			case 'theme_mode.dark': return '深色';
			case 'theme_mode.system': return '跟随系统';
			case 'word_pronunciation.us': return '美';
			case 'word_pronunciation.uk': return '英';
			case 'tray_context_menu.item_show': return '显示';
			case 'tray_context_menu.item_quick_start_guide': return '快速入门';
			case 'tray_context_menu.item_discussion': return '加入讨论';
			case 'tray_context_menu.item_quit_app': return '退出比译';
			case 'tray_context_menu.item_discussion_subitem_discord_server': return '加入 Discord';
			case 'tray_context_menu.item_discussion_subitem_qq_group': return '加入 QQ 群';
			case 'app.home.newversion_banner_text_found_new_version': return ({required Object version}) => '发现新版本：${version}';
			case 'app.home.newversion_banner_btn_update': return '立即更新';
			case 'app.home.limited_banner_title': return '功能受限，请根据提示进行检查。';
			case 'app.home.limited_banner_text_screen_capture': return '授予屏幕录制权限';
			case 'app.home.limited_banner_text_screen_selection': return '授予辅助功能权限';
			case 'app.home.limited_banner_btn_allow': return '允许';
			case 'app.home.limited_banner_btn_go_settings': return '前往设置';
			case 'app.home.limited_banner_btn_check_again': return '重新检查';
			case 'app.home.limited_banner_tip_help': return '查看帮助文档';
			case 'app.home.limited_banner_msg_allow_access_tip': return '点击「授权」后如无任何响应，请点击「前往设置」进行手动设置。';
			case 'app.home.limited_banner_msg_all_access_allowed': return '屏幕取词功能已启用';
			case 'app.home.limited_banner_msg_all_access_not_allowed': return '未获得所需权限，\n请重新检查并进行设置。';
			case 'app.home.input_hint': return '在此处输入单词或文本';
			case 'app.home.text_extracting_text': return '正在提取文字...';
			case 'app.home.tip_translation_mode': return ({required Object mode}) => '当前翻译模式：${mode}';
			case 'app.home.tip_extract_text_from_screen_capture': return '截取屏幕区域并识别文字';
			case 'app.home.tip_extract_text_from_clipboard': return '读取剪切板内容';
			case 'app.home.btn_clear': return '清空';
			case 'app.home.btn_trans': return '翻译';
			case 'app.home.msg_please_enter_word_or_text': return '未输入或未提取到文本';
			case 'app.home.msg_capture_screen_area_canceled': return '截取屏幕区域已取消';
			case 'app.record_shortcut.title': return '录制你的快捷键';
			case 'app.ocr_engine_types.title': return '引擎类型';
			case 'app.ocr_engines.title': return '文字识别引擎';
			case 'app.ocr_engines.msg.no_available_engines': return '无可用的引擎';
			case 'app.ocr_engines.private.title': return '私有';
			case 'app.ocr_engines_new.title': return '添加文字识别引擎';
			case 'app.ocr_engines_new.engine_type.title': return '引擎类型';
			case 'app.ocr_engines_new.option.title': return '选项';
			...
			case 'app.settings.kLayout.navgroup.client': return '客户端';
			case 'app.settings.kLayout.navgroup.integrations': return '服务接入';
			case 'app.settings.kLayout.navgroup.resources': return '资源';
			case 'app.settings.about.title': return '关于';
			case 'app.settings.about.package_info.version': return '版本号';
			case 'app.settings.about.package_info.build_number': return '内部版本号';
			case 'app.settings.advanced.title': return '高级';
			case 'app.settings.advanced.launch_at_login.title': return '开机自启动';
			case 'app.settings.appearance.title': return '外观';
			case 'app.settings.appearance.subtitle': return '改变你的客户端的外观。';
			case 'app.settings.appearance.tray_icon.title': return '托盘图标';
			case 'app.settings.appearance.tray_icon.style.title': return '托盘图标样式';
			case 'app.settings.appearance.tray_icon.show.title': return '显示托盘图标';
			case 'app.settings.appearance.max_window_height.title': return '最大窗口高度（逻辑像素）';
			case 'app.settings.changelog.title': return '变更日志';
			case 'app.settings.changelog.subtitle': return '看看我们正在开发哪些很酷的新功能。';
			case 'app.settings.general.title': return '通用';
			case 'app.settings.general.subtitle': return '与客户端相关的通用设置。';
			case 'app.settings.general.default_detect_text_engine.title': return '默认文字识别引擎';
			case 'app.settings.general.extract_text.auto_copy_detected_text.title': return '自动复制检测到的文本';
			case 'app.settings.general.default_translate_engine.title': return '默认翻译引擎';
			case 'app.settings.general.translation_mode.title': return '翻译模式';
			case 'app.settings.general.default_detect_language_engine.title': return '默认语种识别引擎';
			case 'app.settings.general.translation_target.title': return '翻译目标';
			case 'app.settings.general.translate.double_click_copy_result.title': return '双击复制翻译结果';
			case 'app.settings.general.input_settings.title': return '输入设置';
			case 'app.settings.general.input_settings.submit_with_enter.title': return '用 Enter 提交';
			case 'app.settings.general.input_settings.submit_with_meta_enter.title': return '用 Ctrl + Enter 提交';
			case 'app.settings.general.input_settings.submit_with_meta_enter_mac.title': return '用 ⌘ + Enter 提交';
			case 'app.settings.keybinds.title': return '快捷键';
			case 'app.settings.keybinds.subtitle': return '查看和管理客户端快捷键。';
			case 'app.settings.keybinds.window.show_or_hide.title': return '显示/隐藏';
			case 'app.settings.keybinds.window.hide.title': return '隐藏';
			case 'app.settings.keybinds.extract_text.title': return '屏幕/剪切板取词';
			case 'app.settings.keybinds.extract_text.from_selection.title': return '选中文字';
			case 'app.settings.keybinds.extract_text.from_capture.title': return '截取区域';
			case 'app.settings.keybinds.extract_text.from_clipboard.title': return '剪切板';
			case 'app.settings.keybinds.input_assist_function.title': return '输入辅助功能';
			case 'app.settings.keybinds.input_assist_function.translate_input_content.title': return '翻译当前输入框内容';
			case 'app.settings.language.title': return '语言';
			case 'app.settings.ocr_engines.title': return '文字识别';
			case 'app.settings.ocr_engines.private.title': return '私有';
			case 'app.settings.ocr_engines.private.description': return '长按项目以重新排序';
			case 'app.settings.translation_engines.title': return '文本翻译';
			case 'app.settings.translation_engines.private.title': return '私有';
			case 'app.settings.translation_engines.private.description': return '长按项目以重新排序';
			case 'app.supported_languages.title': return '支持的语言';
			case 'app.supported_languages.all.title': return '全部';
			case 'app.translation_engine_types.title': return '引擎类型';
			case 'app.translation_engines.title': return '文本翻译引擎';
			case 'app.translation_engines.msg.no_available_engines': return '无可用的引擎';
			case 'app.translation_engines.private.title': return '私有';
			case 'app.translation_engines_new.title': return '添加文本翻译引擎';
			case 'app.translation_engines_new.engine_type.title': return '引擎类型';
			case 'app.translation_engines_new.support_interface.title': return '支持接口';
			case 'app.translation_engines_new.option.title': return '选项';
			case 'app.translation_targets.kNew.title': return '添加翻译目标';
			case 'app.translation_targets.kNew.title_with_edit': return '编辑翻译目标';
			case 'app.translation_targets.kNew.source_language': return '源语言';
			case 'app.translation_targets.kNew.target_language': return '目标语言';
			case 'widget.record_shortcut_dialog.title': return '自定义快捷键';
			default: return null;
		}
	}
}
